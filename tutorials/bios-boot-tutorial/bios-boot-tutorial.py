...
def stepKillAll():
    run('killall kaxisd defios || true')
    sleep(1.5)
def stepStartWallet():
    startWallet()
    importKeys()
...
parser.add_argument('--cleos', metavar='', help="Cleos command", default='../../build/programs/cleos/claxis --wallet-url http://127.0.0.1:6666 ')
parser.add_argument('--nodeos', metavar='', help="Path to nodeos binary", default='../../build/programs/nodeos/defios')
parser.add_argument('--keosd', metavar='', help="Path to keosd binary", default='../../build/programs/keosd/kaxisd')
