...
namespace eosio { namespace chain {
   ...
   builtin_protocol_feature_codenames =
      boost::assign::map_list_of<builtin_protocol_feature_t, builtin_protocol_feature_spec>
   	   	 ...
   	   	 // preactivate_feature already in genesis.
//         (
//
//
...
//         )
   ...
   // default in axis. activated in eosio_contract.cpp.
...
*/
		 ...
		 //webauthn_key already activated in config.hpp.
...
//         } )
		 ...
		 // wtmsig_block_signatures already in genesis.
